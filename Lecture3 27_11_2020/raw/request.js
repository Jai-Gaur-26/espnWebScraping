...
//function requestKaAns(err,response,html){
    //console.log(err);
    // console.log(res.statusCode);//this will tell the status of response in a numerical value. 200 -> no error found
...
function MainMatchCb(err,res,html){
    let sTool= cheerio.load(html);//sTool is selector tool. Now we can find any element in our html page using sTool
